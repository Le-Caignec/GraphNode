...
export class ERC721__getKittyResult {
  value0: boolean;
  value1: boolean;
  value2: BigInt;
  value3: BigInt;
...
export class ERC721 extends ethereum.SmartContract {
  ...
  getKitty(_id: BigInt): ERC721__getKittyResult {
    let result = super.call(
      "getKitty",
    ...
    return new ERC721__getKittyResult(
      result[0].toBoolean(),
      result[1].toBoolean(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getKitty(_id: BigInt): ethereum.CallResult<ERC721__getKittyResult> {
    let result = super.tryCall(
      "getKitty",
      "getKitty(uint256):(bool,bool,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_id)]
